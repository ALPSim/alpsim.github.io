...
2Dイジングモデルは統計力学において最も重要なモデルの一つです。正方格子上のスピンがアップまたはダウンのいずれかを向き、最近接スピン間に強磁性結合 $J > 0$ が働くモデルです。Onsager は1944年にこのモデルの厳密解を導き、$T_c = 2J / \ln(1 + \sqrt{2}) \approx 2.269\, J/k_B$ で相転移が起こることを示しました。$T_c$ 以下ではスピンが自発的に秩序化し、$T_c$ 以上では熱揺らぎがその秩序を壊します。
