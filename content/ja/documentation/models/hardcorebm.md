...
このモデル名を冠した専用の ALPS チュートリアルはありませんが、これは [ALPS モデル定義](../../intro/modeldef)の各ページを通じて使われている実例であり、[ボーズ・ハバードモデル](../bhm)のチュートリアル（MC-05）は、密接に関連する有限 $U$ モデルにおいて、同じ worm の手法を示しています。
