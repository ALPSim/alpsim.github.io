...
ALPSおよびそのすべてのアプリケーションは、[MITライセンス](https://github.com/ALPSim/ALPS/blob/master/LICENSE.txt)のもとで公開されています。これは現在利用可能な最も寛容なオープンソースライセンスの一つです。自分のソフトウェアへの組み込みや商業利用を含む、ほぼあらゆる用途でALPSを自由に使用・改変・配布することができます。
