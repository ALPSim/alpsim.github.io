...
---
title: Artículos de Implementación y Algoritmos
description: "Artículos de Implementación y Algoritmos de ALPS"
weight: 2
---

A continuación se enumeran los artículos de implementación de las aplicaciones individuales de ALPS y los artículos de algoritmo originales en los que se basan.

---

### Planificador Paralelo de Monte Carlo de ALPS

*Fuente: [`src/alps/scheduler/`](https://github.com/ALPSim/ALPS/tree/master/src/alps/scheduler)*
...
### Algoritmo de Loop QMC — `looper`

*Fuente: [`applications/qmc/looper/`](https://github.com/ALPSim/ALPS/tree/master/applications/qmc/looper)*
...
### El código Directed Loop en representación SSE

*Fuente: [`applications/qmc/sse/`](https://github.com/ALPSim/ALPS/tree/master/applications/qmc/sse), [`sse2/`](https://github.com/ALPSim/ALPS/tree/master/applications/qmc/sse2), [`sse4/`](https://github.com/ALPSim/ALPS/tree/master/applications/qmc/sse4)*
...
### QMC de Histograma Plano de Wang-Landau Cuántico — `qwl`

*Fuente: [`applications/qmc/qwl/`](https://github.com/ALPSim/ALPS/tree/master/applications/qmc/qwl)*
...
### ALPS-DMFT: Solucionadores de Impureza CT-QMC y Teoría de Campo Medio Dinámico

*Fuente: [`applications/dmft/`](https://github.com/ALPSim/ALPS/tree/master/applications/dmft)*
...
### Aplicaciones DMRG y de Estados de Producto Matricial — `dmrg`

*Fuente: [`applications/dmrg/`](https://github.com/ALPSim/ALPS/tree/master/applications/dmrg)*
