...
Estos ejemplos pueden iniciarse invocando directamente un comando o un script de python en la línea de comandos. Ejecutar manualmente uno de los conjuntos de parámetros de dmft, por ejemplo entrando al directorio 'beta_14_U3_tsqrt2' en `tutorials/dmft-0j-xxx`, y ejecutando el código dmft '/opt/alps/bin/dmft xxx.param', lleva a los mismos resultados.

Nota: el ejemplo combina los tutoriales [DMFT-02 CT-HYB: el solucionador QMC CT-HYB](../dmft02), [DMFT-03 CT-INT: el solucionador QMC CT-INT](../dmft03) y [DMFT-07 El solucionador de Hirsch-Fye](../dmft07) .
...
Después de ejecutar estas simulaciones, compare el resultado con los resultados de Hirsch-Fye de la sección [Hirsch-Fye](../dmft07) o de la revisión de DMFT, o con los resultados de expansión de interacción de la sección Expansión de Interacción CT-INT. Para volver a ejecutar una simulación, puede especificar una solución de partida definiendo G0OMEGA_INPUT, por ejemplo copiando G0omga_output a G0_omega_input, especificando G0OMEGA_INPUT = G0_omega_input en el archivo de parámetros y volviendo a ejecutar el código. Puede observar la transición a la fase antiferromagnética graficando las funciones de Green con el siguiente script:
...
El código se ejecutará hasta por 10 iteraciones de autoconsistencia. En el directorio en el que ejecute el programa encontrará archivos de funciones de Green G_tau_i, así como las autoenergías (selfenergy_i) y funciones de Green en espacio de frecuencias G_omega_i en su directorio de salida. G_tau en estos ejemplos tiene dos columnas: una de espín arriba y otra de espín abajo. La entrada en $\beta$ es la densidad negativa; donde difiere fuera de las barras de error, el sistema está en una fase antiferromagnética. Puede ejecutar las siguientes líneas en el shell de python para graficar las funciones de Green para distintos $\beta$ y comparar su resultado con la Fig. 11 de [Georges it et al.](https://journals.aps.org/rmp/abstract/10.1103/RevModPhys.68.13).
