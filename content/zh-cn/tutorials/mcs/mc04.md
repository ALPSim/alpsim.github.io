...
The parameter file <a class="alps-download" href="https://raw.githubusercontent.com/ALPSim/ALPS/master/tutorials/mc-04-measurements/parm4" data-filename="parm4" target="_blank" rel="noopener">`parm4`</a> sets up Monte Carlo simulations of the quantum mechanical S=1/2 Heisenberg model on a square lattice, and enables various measurement options:
...
To set up and run the simulation in Python we use the script <a class="alps-download" href="https://raw.githubusercontent.com/ALPSim/ALPS/master/tutorials/mc-04-measurements/tutorial4.py" data-filename="tutorial4.py" target="_blank" rel="noopener">`tutorial4.py`</a>:
