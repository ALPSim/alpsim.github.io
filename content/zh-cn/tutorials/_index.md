...
每个教程均以一个具体模型为例——通常是自旋链、Hubbard 模型或 玻色-哈伯德 系统——逐步讲解参数设置、运行模拟及分析输出的全过程。
...
从简单的 Metropolis 抽样与自相关分析出发，逐步介绍自旋和 玻色-哈伯德 模型的圈算法、有向圈量子蒙特卡洛、蠕虫算法，以及扩展系综王-朗道抽样，并探讨经典与量子相变的数值研究。
