...
aliases:
  ...
  - /zh-cn/documentation/start/path/
---
...
<div class="btn-grid">
{{< cta-button text="二进制安装" link="../install/binary" icon="download" >}}
{{< cta-button text="源码安装" link="../install/source" icon="code" >}}
{{< cta-button text="Spack 安装" link="../install/spack" icon="inventory_2" >}}
</div>
