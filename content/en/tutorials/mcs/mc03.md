...
The parameter file <a href="../codes/mc-03-magnetization/parm3a" download>`parm3a`</a>:
...
The script <a href="../codes/mc-03-magnetization/tutorial3a.py" download>`tutorial3a.py`</a>:
...
The parameter file <a href="../codes/mc-03-magnetization/parm3b" download>`parm3b`</a> uses the same structure as `parm3a` with these changes:
...
The script <a href="../codes/mc-03-magnetization/tutorial3b.py" download>`tutorial3b.py`</a> adapts `tutorial3a.py`: rename the prefix to `parm3b`, change `LATTICE` to `"ladder"`, replace `J` with `J0=J1=1`, and extend the field scan to 3.5.
...
After running both simulations in the same folder, the script <a href="../codes/mc-03-magnetization/tutorial3full.py" download>`tutorial3full.py`</a> overlays the two magnetization curves on a single plot:
