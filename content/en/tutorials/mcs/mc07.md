...
Download <a href="../codes/mc-07-phase-transition/parm7b" download>`parm7b`</a> and run:
...
The first part of <a href="../codes/mc-07-phase-transition/tutorial7b.py" download>`tutorial7b.py`</a> sets up and launches the same simulation:
...
Download <a href="../codes/mc-07-phase-transition/parm7a" download>`parm7a`</a> and run:
...
Using <a href="../codes/mc-07-phase-transition/tutorial7a.py" download>`tutorial7a.py`</a>:
