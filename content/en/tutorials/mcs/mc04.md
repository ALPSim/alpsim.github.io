...
The parameter file <a class="alps-download" href="https://raw.githubusercontent.com/ALPSim/ALPS/daa73925b95389c0ec5e0d76ce592b56f3cd6738/tutorials/mc-04-measurements/parm4" data-filename="parm4" target="_blank" rel="noopener">`parm4`</a> enables three additional measurement flags alongside the standard parameters:
...
`MEASURE[Green Function]` records the imaginary-time (single-site) Green function $G(\tau) = \langle S^z_i(\tau)\,S^z_i(0)\rangle$, which decays as $G(\tau)\sim e^{-\Delta\tau}$ at long $\tau$ and can be analytically continued to obtain spectral information.
...
The script <a class="alps-download" href="https://raw.githubusercontent.com/ALPSim/ALPS/daa73925b95389c0ec5e0d76ce592b56f3cd6738/tutorials/mc-04-measurements/tutorial4.py" data-filename="tutorial4.py" target="_blank" rel="noopener">`tutorial4.py`</a>:
