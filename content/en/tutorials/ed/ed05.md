...
In this tutorial, we will follow up on the last part of the ED-04 tutorial, where the Heisenberg chain was considered. We will add a next-nearest neighbour coupling term $J_2 \sum_{\langle \langle i,j \rangle \rangle} S_i \cdot S_j$ to the Hamiltonian.
