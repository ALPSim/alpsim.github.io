...
We have just replaced the "chain lattice" by a "ladder" and defined two separate coupling constants $J_0$, $J_1$ for the legs and the rungs, respectively. Apart from that, we have reduced the linear system size L because the ladder has 2L spins.
...
- Why does putting together spectra from different system sizes produce nice bands? What about if we consider $L$ and $2L$?
