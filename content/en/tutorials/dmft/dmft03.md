...
Evaluation proceeds exactly as in [DMFT-02 Hybridization](../dmft02), using <a class="alps-download" href="https://raw.githubusercontent.com/ALPSim/ALPS/daa73925b95389c0ec5e0d76ce592b56f3cd6738/tutorials/dmft-03-interaction/tutorial3eval.py" data-filename="tutorial3eval.py" target="_blank" rel="noopener">`tutorial3eval.py`</a> (identical in structure to `tutorial2eval.py`). First, the imaginary-time Green's function for both flavors, directly appended to `tutorial3.py`:
