...
At each DMFT iteration i the self-energy is written to the file `selfenergy_i`. Plot the converged self-energy and compare your results to Fig. 15 in [Georges et al.](https://journals.aps.org/rmp/abstract/10.1103/RevModPhys.68.13). Alternatively you may use the python script for this task as it is done in the tutorial [DMFT-02 Hybridization](../dmft02).

Warning: this takes a long time to run on a single workstation; you may shorten the two runs to about $2\times 24$ minutes in total if you do not need very high precision.
