...
description: "GSoC Contributor Guidance"
toc: false
sidebar:
  exclude: true
type: event
...
Once you have selected a project assignment from the [Ideas List](https://alps.comp-phys.org/events/2026/gsoc_ideas/) page, please include a schedule with milestones and deliverables.
...
1. **Title + short abstract (5–10 lines)**
   What you will build and what “success” looks like.

2. **Motivation and impact**
   Who benefits (users, maintainers, new contributors)? What pain point does it solve?

3. **Technical approach**
   What parts of ALPS you will touch, planned interfaces/APIs, data formats, and design choices.

4. **Deliverables (must-have / optional / stretch)**
   Be explicit about what will be merged by midterm and final.

5. **Timeline (weekly milestones)**
   A plan with measurable outputs and some buffer time.

6. **Testing and validation plan**
   What tests you’ll add (unit/integration), and how you’ll validate correctness or stability.

7. **About you**
   Relevant experience, links to GitHub/projects, and your availability/conflicts.

8. **Communication plan**
   How often you’ll post updates and where (e.g., GitHub contributions and weekly GitHub discussion posts).
